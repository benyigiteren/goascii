	...
	if _, err := os.Stat(dbPath); os.IsNotExist(err) {
		...
		db.state = DBState{
			...
			Animations: []Animation{
				...
				{
					Slug:         "dvd",
					Name:         "Meme - DVD Zıplayan Logo (Screensaver Bait)",
					Type:         "procedural",
					FrameDelayMs: 50,
					FramesCount:  0,
					CreatedAt:    time.Now(),
				...
				{
					Slug:         "forrest",
					Name:         "ASCII Live - Forrest Gump Koşucusu",
					Type:         "procedural",
					FrameDelayMs: 70,
					FramesCount:  0,
					CreatedAt:    time.Now(),
				...
				{
					Slug:         "bomb",
					Name:         "ASCII Live - Patlayan Bomba",
					Type:         "procedural",
					FrameDelayMs: 90,
					FramesCount:  0,
					CreatedAt:    time.Now(),
				...
				{
					Slug:         "nyan",
					Name:         "ASCII Live - Nyan Cat (ascii-live)",
					Type:         "procedural",
					FrameDelayMs: 70,
					FramesCount:  0,
					CreatedAt:    time.Now(),
				...
				{
					Slug:         "india",
					Name:         "ASCII Live - India Dansçısı",
					Type:         "procedural",
					FrameDelayMs: 70,
					FramesCount:  0,
					CreatedAt:    time.Now(),
				...
				{
					Slug:         "maxwell",
					Name:         "ASCII Live - Maxwell Cat (3D)",
					Type:         "procedural",
					FrameDelayMs: 70,
					FramesCount:  0,
					CreatedAt:    time.Now(),
				...
				{
					Slug:         "brittany",
					Name:         "ASCII Live - Brittany (Vogue Dansı)",
					Type:         "procedural",
					FrameDelayMs: 90,
					FramesCount:  0,
					CreatedAt:    time.Now(),
				...
				{
					Slug:         "batman-running",
					Name:         "ASCII Live - Batman & Robin Koşucusu",
					Type:         "procedural",
					FrameDelayMs: 70,
					FramesCount:  0,
					CreatedAt:    time.Now(),
				...
				{
					Slug:         "spidyswing",
					Name:         "ASCII Live - Spiderman Swing",
					Type:         "procedural",
					FrameDelayMs: 70,
					FramesCount:  0,
					CreatedAt:    time.Now(),
				...
				{
					Slug:         "rick",
					Name:         "ASCII Live - Rick Astley (Never Gonna)",
					Type:         "procedural",
					FrameDelayMs: 100,
					FramesCount:  0,
					CreatedAt:    time.Now(),
				...
				},
				{
					...
					Name:         "ASCII Live - Can You Hear Me",
					Type:         "procedural",
					FrameDelayMs: 100,
					FramesCount:  0,
					CreatedAt:    time.Now(),
				...
				{
					Slug:         "earth-live",
					Name:         "ASCII Live - Dünya (ascii-live versiyonu)",
					Type:         "procedural",
					FrameDelayMs: 70,
					FramesCount:  0,
					CreatedAt:    time.Now(),
...
func (db *DB) ensureBuiltins() {
	builtins := map[string]Animation{
		...
		"nyan": {
			Slug:         "nyan",
			Name:         "ASCII Live - Nyan Cat (ascii-live versiyonu)",
			Type:         "procedural",
			FrameDelayMs: 70,
			FramesCount:  0,
			CreatedAt:    time.Now(),
